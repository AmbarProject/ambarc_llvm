...
# =========================
echo "🔹 C:"
run_and_record "C" "../../c_files/n-body"
sleep 2

echo "🔹 Rust:"
run_and_record "Rust" "../../rust_files/n-body"
sleep 2

echo "🔹 Ambar:"
run_and_record "Ambar" "../../ambar_files/n-body"
sleep 2

echo "🔹 JavaScript:"
run_and_record "JavaScript" "node ../../javascript_files/n-body.js"
sleep 2

echo "🔹 Java:"
# Se necessário, compile aqui (exemplo comentado)
# javac ../../java_files/PiCalculator.java
run_and_record "Java" "java -cp ../../java_files NBodyTest"
sleep 2

echo "🔹 Python:"
run_and_record "Python" "python3 ../../python_files/n-body.py"
sleep 2

echo "🔹 R:"
run_and_record "R" "Rscript ../../r_files/n-body.R"
sleep 2
