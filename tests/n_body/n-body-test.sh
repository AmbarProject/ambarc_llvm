...
N_RUNS=10 # número de repetições (ajuste conforme necessário)
...
# =========================
echo "🔹 C:"
c_time=$(average_time "../../c_files/n-body")
...
# =========================
echo "🔹 Rust:"
rust_time=$(average_time "../../rust_files/n-body")
...
# =========================
echo "🔹 Ambar:"
ambar_time=$(average_time "../../ambar_files/n-body")
...
# =========================
echo "🔹 JavaScript:"
js_time=$(average_time "node ../../javascript_files/n-body.js")
...
java_time=$(average_time "java -cp ../../java_files NBodyTest")
...
# =========================
echo "🔹 Python:"
python_time=$(average_time "python3 ../../python_files/n-body.py")
