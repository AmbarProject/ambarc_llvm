...
namespace yy {
#line 212 "src/parser/parser.hpp"
...
# endif
    ...
    typedef std::unique_ptr<ambar::ASTNode> value_type;
#endif
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_NUM_INT = 4,                           // NUM_INT
        S_NUM_REAL = 5,                          // NUM_REAL
        S_BOOL_TRUE = 6,                         // BOOL_TRUE
        S_BOOL_FALSE = 7,                        // BOOL_FALSE
        S_FUNC = 8,                              // FUNC
        S_RETURN = 9,                            // RETURN
        S_IF = 10,                               // IF
        S_ELSE = 11,                             // ELSE
        ...
        S_func_decl = 45,                        // func_decl
        S_opt_params = 46,                       // opt_params
        S_params = 47,                           // params
        S_type = 48,                             // type
        S_stmt = 49,                             // stmt
        S_assign_stmt = 50,                      // assign_stmt
        S_return_stmt = 51,                      // return_stmt
        S_if_stmt = 52,                          // if_stmt
        S_while_stmt = 53,                       // while_stmt
        S_block = 54,                            // block
        S_stmt_list = 55,                        // stmt_list
        S_expr = 56,                             // expr
        S_logic_expr = 57,                       // logic_expr
        S_rel_expr = 58,                         // rel_expr
        S_arith_expr = 59,                       // arith_expr
        S_term = 60,                             // term
        S_factor = 61                            // factor
      };
    };
...
#line 886 "src/parser/parser.hpp"
